    ...
    try {
      ...
      if (isNew) {
        ...
        const payload = {
          ...
          referredByEmail: form.referredByEmail,
               ...
               <div className="space-y-4 bg-neutral-50 p-5 rounded-2xl border border-neutral-100">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      type="password" 
                      minLength={6} 
                      placeholder={student ? "Leave blank to keep current password" : "Minimum 6 characters"} 
                      value={form.password || ""} 
                ...
                <div className="space-y-4 bg-neutral-50 p-5 rounded-2xl border border-neutral-100">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     ...
                     <div>
                       ...
                       <input type="email" placeholder="referral@email.com" value={form.referredByEmail || ""} onChange={e => setForm({...form, referredByEmail: e.target.value})} className="w-full px-4 py-2.5 rounded-xl bg-white border border-neutral-200 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 focus:outline-none transition-all text-neutral-900 shadow-sm" />
                     </div>
                     <div>
